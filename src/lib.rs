...
pub mod math {
    ...
    /// The maximum number of possible rotations and translations of a rigid
    /// body.
    ...
    /// The velocity type combining the linear velocity and the angular
    /// velocity.
    ...
    /// The type of a mutable slice of the constraint jacobian in twist
    /// coordinates.
